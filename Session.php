<?php
	...
	use \Sessions\SessionOpenssl;
	use \Sessions\SessionConfig;
	...
	class Session extends SessionConfig
	{
		...
		public function start ()
		{
			if (session_id() == '' || !isset($_SESSION) || session_status() === PHP_SESSION_NONE)
			{
				...
				session_regenerate_id($this->RegenerateSessionID);
			}
		}
		...
		{
			return $_SESSION[$name] = SessionOpenssl::encrypt($value);
		}
		...
		{
			return SessionOpenssl::decrypt($_SESSION[$name]);
		}
